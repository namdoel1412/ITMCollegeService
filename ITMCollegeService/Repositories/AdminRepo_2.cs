...
namespace ITMCollegeService.Repositories
{
    ...
    {
        public Task<bool> CreateAdminAsync(CreateAdminDTO body);
        public Task<bool> UpdateAdmin(int id, CreateAdminDTO body);
    ...
    public class AdminRepo_2 : IAdminRepo
    {
        public async Task<bool> CreateAdminAsync(CreateAdminDTO body)
        {
        ...
        public async Task<bool> UpdateAdmin(int id, CreateAdminDTO body)
        {
